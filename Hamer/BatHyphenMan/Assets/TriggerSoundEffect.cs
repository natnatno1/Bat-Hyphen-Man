...
public class TriggerSoundEffect : StateMachineBehaviour
{
    ...
    {
        EnemyScript = animator.gameObject.GetComponent<HumanMovement>().Attacker.GetComponentInParent<Enemy_Controller>();
